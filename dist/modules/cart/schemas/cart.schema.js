...
exports.CartDetailSchema = exports.CartDetail = exports.CartSchema = exports.Cart = void 0;
...
exports.Cart = Cart;
__decorate([
    (0, mongoose_1.Prop)({ type: mongoose.Schema.Types.ObjectId, ref: 'Customer', required: true, unique: true }),
    __metadata("design:type", mongoose.Schema.Types.ObjectId)
], Cart.prototype, "ma_khach_hang", void 0);
...
__decorate([
    ...
    __metadata("design:type", mongoose.Schema.Types.ObjectId)
], CartDetail.prototype, "ma_gio_hang", void 0);
__decorate([
    (0, mongoose_1.Prop)({ type: mongoose.Schema.Types.ObjectId, ref: 'ProductVariant', required: true }),
    __metadata("design:type", mongoose.Schema.Types.ObjectId)
], CartDetail.prototype, "ma_sp_chi_tiet", void 0);
__decorate([
    (0, mongoose_1.Prop)({ required: true, default: 1 }),
    __metadata("design:type", Number)
], CartDetail.prototype, "so_luong", void 0);
exports.CartDetail = CartDetail = __decorate([
    (0, mongoose_1.Schema)()
], CartDetail);
exports.CartDetailSchema = mongoose_1.SchemaFactory.createForClass(CartDetail);
